...
var (
	...
	surname = flag.String("surname", defaultname, "Surname to report")
...
func main() {
	...
	*/
    ...
    r, err := c.IdentifyCondition(ctx, &pb.SeverityRequest{Name : *name, Surname : *surname, Condition : *condition})
    if err != nil{
